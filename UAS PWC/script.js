window.addEventListener('DOMContentLoaded', () => {
  ...
  btnCheckout.addEventListener('click', function() {
    ...
    if (product > 0) {
      ...
      const message = `jumlah barang yang anda beli adalah sebanyak ${product} barang. dan total biaya yang harus anda keluarkan adalah ${price.textContent} terimakasih telah membeli produk kami`;
